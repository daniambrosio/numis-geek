...
import { api, type AssetClass, type AssetOut, type AssetRequest, type FinancialInstitutionOut, type UserOut } from '../../lib/api'
...
export default function Assets() {
  ...
  useEffect(() => {
    api.me()
      .then(u => {
        // sysadmin should use /sysadmin/assets
        if (u.role === 'sysadmin') {
  ...
  }, [me, classFilter, includeInactive, search])
    ...
    <AppLayout user={me}>
      <div className="w-full">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-xl font-semibold text-gray-900 dark:text-white">Ativos</h1>
          <button
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-200 dark:border-gray-800">
                  {['Ticker', 'Nome', 'Classe', 'Subtipo', 'Custodiante', 'Moeda', 'Atualizado', ''].map((h, i) => (
