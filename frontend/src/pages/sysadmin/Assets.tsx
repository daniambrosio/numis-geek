...
export default function SysadminAssets() {
  ...
  const filtered = useMemo(() => {
    ...
    if (countrySel.length) xs = xs.filter(a => countrySel.includes(a.country))
    if (fiSel.length) xs = xs.filter(a => fiSel.includes(a.financial_institution_id))
    return xs
